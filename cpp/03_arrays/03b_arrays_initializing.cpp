...
int main(void) {
  ...
  float v1[3] = {8.6, -3, 1} ;
  float v2[4] = {-1, 2}; // v2[2] and v2[3] default to 0
  float v3[9] = {} ;     // all values set to 0
  ...
  // 
  // Answer: the base memory addresses for v1 and v2.  That is, the
  // location where v1[0] and v2[0] are stored.
