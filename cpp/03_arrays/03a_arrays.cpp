...
int main(void) {
  ...
  // up to you (whether you print an endl or space between each
  // element).
  ...
  int a[rand()%12+1];   // create random-length array (SEE WARNING BELOW!)
  for (int i=0; i<sizeof(a)/sizeof(a[0]); i++) {
    cout << i << endl;
  }

  // WARNING!  The above code is NOT compliant with C++ standards,
  // and may not operate correctly in some compilers (and should NEVER
  ...
  //
  // This is a more advanced concept that we will discuss  
  // shortly under the topic of dynamic memory allocation
